...
class SyncationChartScreen extends StatefulWidget {
  const SyncationChartScreen({super.key});

  @override
  State<SyncationChartScreen> createState() => _SyncationChartScreenState();
}

class _SyncationChartScreenState extends State<SyncationChartScreen> {
